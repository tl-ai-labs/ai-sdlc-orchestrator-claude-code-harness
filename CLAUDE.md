...
Rules for Claude Code sessions editing this repo. The full contributor guide is [CONTRIBUTING.md](CONTRIBUTING.md); this file states the writing conventions plainly so you don't have to fetch it.
